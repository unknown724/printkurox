  ...
  return (
    <div className="rounded-2xl border border-zinc-200 dark:border-white/10 bg-white dark:bg-[#16161c]/90 shadow-xs overflow-hidden">
      ...
      <button
        ...
        className="w-full p-4 flex items-center justify-between text-left hover:bg-zinc-50 dark:hover:bg-white/[0.04] transition-colors group"
      >
                ...
                <button
                  ...
                  className={`p-2 rounded-lg text-left border transition-all ${
                    options.scaling === item.id
                      ...
                      : 'border-zinc-200 bg-zinc-50/70 text-zinc-600 hover:border-zinc-300 hover:text-zinc-900 dark:border-white/10 dark:bg-white/[0.04] dark:text-zinc-400 dark:hover:border-white/20 dark:hover:text-zinc-100'
                  }`}
                >
