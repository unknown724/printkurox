  ...
  return (
    <>
      <footer className="relative z-10 border-t border-slate-200/80 dark:border-white/5 py-6 px-4 text-center text-xs text-slate-500 dark:text-slate-400 space-y-3">
        <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1.5 text-[11px] text-slate-600 dark:text-slate-400">
          <button
            ...
            <div className="p-5 overflow-y-auto space-y-4 text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
              ...
              {activeTab === 'contact' && (
                <>
                  ...
                  <div className="p-3 rounded-xl bg-slate-100 dark:bg-slate-900/80 border border-slate-200 dark:border-white/5 space-y-2 text-slate-700 dark:text-slate-300">
