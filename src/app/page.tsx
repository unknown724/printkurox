...
export default function HomePage() {
  ...
  return (
    <div className="space-y-5 pb-12">
      {/* Pickup Banner */}
      <div className="flex items-center justify-between px-3.5 py-2.5 rounded-xl bg-indigo-500/8 border border-indigo-500/18 text-xs text-indigo-300 animate-fade-in-up">
        <div className="flex items-center space-x-2">
          <MapPin className="w-3.5 h-3.5 text-indigo-400 shrink-0" />
          <span>
            Pickup:{' '}
            <strong className="text-white font-semibold">Block B, Room 29</strong>
          </span>
        </div>
      ...
      {/* Admin Banner */}
      {isAdmin && (
        <div className="flex items-center justify-between px-3.5 py-2.5 rounded-xl bg-gradient-to-r from-amber-500/12 via-orange-500/8 to-amber-500/12 border border-amber-500/25 text-xs text-amber-200 shadow-md shadow-amber-500/5 animate-scale-in">
          <div className="flex items-center space-x-2">
            <Crown className="w-4 h-4 text-amber-400 shrink-0" />
            <span>
              <strong className="text-white">Admin Verified:</strong>{' '}
              {deviceName || 'Authorized Device'} · Free Print Active
            </span>
          </div>
          <Link
            href="/adminkurox"
            className="flex items-center gap-0.5 text-[10px] font-bold text-amber-300 uppercase tracking-wider bg-amber-500/15 hover:bg-amber-500/25 px-2 py-0.5 rounded-lg border border-amber-500/30 transition-colors"
          >
      ...
      <div className="text-center pt-1 pb-2 animate-fade-in-up" style={{ animationDelay: '50ms' }}>
        <div className="inline-flex items-center space-x-1.5 px-3 py-1.5 rounded-full bg-indigo-500/8 border border-indigo-500/18 text-indigo-300 text-[11px] font-bold mb-3 shadow-sm">
        ...
        <div className="mt-4 flex justify-center gap-2.5">
          <div className="flex items-center gap-2.5 px-3.5 py-2.5 rounded-2xl bg-slate-900/80 border border-white/8 shadow-md">
            <span className="w-3 h-3 rounded-full bg-slate-300 ring-2 ring-slate-400/30 shrink-0" />
            <div className="text-left">
              <div className="text-[11px] font-bold text-slate-200">Black &amp; White</div>
              <div className="text-[10px] text-slate-500">₹4/pg · ₹6 double-sided</div>
            </div>
          </div>

          <div className="flex items-center gap-2.5 px-3.5 py-2.5 rounded-2xl bg-gradient-to-r from-pink-950/50 to-slate-900/80 border border-pink-500/25 shadow-md">
            <span className="w-3 h-3 rounded-full bg-gradient-to-tr from-pink-400 to-violet-500 ring-2 ring-pink-500/30 shrink-0" />
            <div className="text-left">
              <div className="text-[11px] font-bold text-pink-200">Full Color</div>
              <div className="text-[10px] text-pink-300/70">₹7/pg · ₹10 double-sided</div>
            </div>
          </div>
        </div>
      </div>
      ...
      >
        ...
        {showRatesModal && (
          <div className="card-premium rounded-2xl p-4 border border-indigo-500/25 text-xs space-y-2 animate-scale-in">
            <div className="flex items-center justify-between pb-2 border-b border-white/5 font-bold text-white">
              <span>Official Kiosk Rate Card</span>
              <button
                onClick={() => setShowRatesModal(false)}
                className="text-slate-400 hover:text-white w-6 h-6 flex items-center justify-center rounded-lg hover:bg-white/5 transition-colors"
              >
                ✕
              </button>
            </div>
            <div className="grid grid-cols-2 gap-2 text-[11px]">
              <div className="p-3 rounded-xl bg-slate-900/70 border border-white/5">
                <p className="font-bold text-slate-200 mb-1.5">Black &amp; White</p>
              ...
              <div className="p-3 rounded-xl bg-pink-950/30 border border-pink-500/15">
                <p className="font-bold text-pink-200 mb-1.5">Color</p>
                <p className="text-slate-400">• Single-Sided: <span className="text-pink-400 font-semibold">₹7 / sheet</span></p>
                <p className="text-slate-400">• Double-Sided: <span className="text-pink-400 font-semibold">₹10 / sheet</span></p>
              </div>
            </div>
      ...
      {uploadedBatch && (
        <>
          ...
          <section className="space-y-2.5 animate-fade-in-up" style={{ animationDelay: '250ms' }}>
            <div className="flex items-center gap-2 px-1 text-xs font-bold text-slate-300 uppercase tracking-wider">
      ...
      {!uploadedBatch && (
        <div className="grid grid-cols-2 gap-3 pt-2 animate-fade-in-up" style={{ animationDelay: '150ms' }}>
          <div className="card-premium rounded-2xl p-4 flex items-start space-x-3 border border-white/6 glass-card-hover cursor-default">
            ...
            <div>
              <p className="text-xs font-bold text-white leading-snug">Hybrid Color</p>
          ...
          <div className="card-premium rounded-2xl p-4 flex items-start space-x-3 border border-white/6 glass-card-hover cursor-default">
            ...
            <div>
              <p className="text-xs font-bold text-white leading-snug">Auto 15-Min Purge</p>
              <p className="text-[11px] text-slate-400 mt-0.5 leading-relaxed">
