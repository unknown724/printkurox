...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      ...
      <body className="antialiased bg-[#070b14] text-slate-100 flex flex-col min-h-screen selection:bg-indigo-500/80 selection:text-white">
        {/* Multi-layered ambient background */}
        <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
          {/* Primary top glow */}
          <div className="ambient-orb absolute -top-32 left-1/2 -translate-x-1/2 w-[700px] h-[400px] bg-indigo-700/18 opacity-80" />
          {/* Secondary right accent */}
          <div className="ambient-orb absolute top-1/3 -right-48 w-[450px] h-[450px] bg-violet-700/12" />
          {/* Tertiary bottom-left */}
          <div className="ambient-orb absolute -bottom-20 -left-32 w-[500px] h-[400px] bg-emerald-700/10" />
        ...
        <header className="relative z-20 border-b border-white/[0.06] bg-[#070b14]/70 backdrop-blur-xl sticky top-0 shadow-[0_1px_0_rgba(255,255,255,0.04)]">
          <div className="max-w-xl mx-auto px-4 h-14 flex items-center justify-between">
            {/* Brand Mark */}
            <div className="flex items-center space-x-2.5">
              <div className="w-8 h-8 rounded-xl bg-gradient-to-tr from-indigo-500 via-violet-500 to-purple-600 flex items-center justify-center shadow-lg shadow-indigo-500/30 ring-1 ring-white/10">
                <svg
